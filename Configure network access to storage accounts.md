...
```mermaid
graph TD;
    A[Redes Virtuales VNET# Configurar el Acceso de Red a las Storage Accounts
...
3. Utilizar un Servicio Endpoint para el acceso desde redes on-premise.] --> B[Configuración de VNET]
    B --> C[Asociación con Storage Account]
```
